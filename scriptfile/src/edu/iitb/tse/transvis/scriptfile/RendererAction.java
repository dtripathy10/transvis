 ...
 * @author dtripathy10
 */
class RendererAction extends AbstractAction implements Presenter.Popup{

    private final RendererService renderer;
    private final SCRIPTDataNode node;

    public RendererAction(RendererService renderer, SCRIPTDataNode node) {
