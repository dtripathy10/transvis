 ...
 * @author dtripathy10
 */
class TRANSVISLogicalView implements LogicalViewProvider {

    private final TRANSVISProject project;

    public TRANSVISLogicalView(TRANSVISProject project) {
    ...
    public Node createLogicalView() {
        ...
        try {
            ...
            FileObject scenes = project.getInputFolder(true);
    ...
    private static final class ScenesNode extends FilterNode {
        ...
        final TRANSVISProject project;

        public ScenesNode(Node node, TRANSVISProject project) throws DataObjectNotFoundException {
