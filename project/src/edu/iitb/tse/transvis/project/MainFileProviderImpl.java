...
public class MainFileProviderImpl extends MainFileProvider{
    private final TRANSVISProject proj;

    private FileObject mainFile = null;

    private boolean checked = false;

    MainFileProviderImpl(TRANSVISProject proj) {
        this.proj = proj;
    }
    ...
    public FileObject getMainFile() {
        ...
        if (mainFile == null && !checked) {
            ...
            String path = props.getProperty(TRANSVISProject.KEY_MAINFILE);
            if (path != null) {
    ...
    public void setMainFile(FileObject file) {
        ...
        if (change) {
            ...
            props.put(TRANSVISProject.KEY_MAINFILE, relPath);
        }
