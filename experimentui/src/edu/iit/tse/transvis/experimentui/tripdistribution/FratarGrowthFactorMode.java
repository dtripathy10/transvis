...
@ActionID(
    category = "Edit",
id = "edu.iit.tse.transvis.experimentui.tripdistribution.FratarGrowthFactorMode")
@ActionRegistration(
    displayName = "#CTL_FratarGrowthFactorMode")
@ActionReference(path = "Menu/Experiment/TripDistribution", position = 3333)
@Messages("CTL_FratarGrowthFactorMode=Fratar Growth Factor Mode")
public final class FratarGrowthFactorMode implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        d.setTitle("Fratar Growth Factor Mode | Tripa Distribution");
